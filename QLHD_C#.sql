...
(
    ...
    MaKH VARCHAR(10) NOT NULL CONSTRAINT FK_HopDong_KhachHang REFERENCES KhachHang(MaKH),
    MaBao VARCHAR(10) NOT NULL CONSTRAINT FK_HopDong_Bao REFERENCES Bao(MaBao),
    MaTheLoai VARCHAR(10) NOT NULL CONSTRAINT FK_HopDong_TheLoai REFERENCES TheLoai(MaTheLoai),
    NgayKy DATE NOT NULL,
    SoNgay INT NOT NULL,
    NhuanBut DECIMAL(18,2) NOT NULL,
